...
for (i in 1:length(unique (s2_raw_threshold$limite0.05)))
{
  ...
  subcom_level_names0.05[,c(2:29)]->subcom_level0.05  #delete names, level and also the negative column
...
s2_raw_Hemiptera_limite0.05[,1:28]->data0.05
rowSums(data0.05)
...
t_s2_f4_Hemiptera_limite0.05[1:28,]->community_Hemiptera_limite0.05 #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data0.05".
...
dim(community_Hemiptera0.05)
community_Hemiptera0.05[which(str_extract (row.names(community_Hemiptera0.05), "_T_") %in% "_T_"),]->community_Hemiptera_Traps0.05
dim(community_Hemiptera_Traps0.05)
community_Hemiptera_Traps0.05[,which(colSums(community_Hemiptera_Traps0.05)!=0)]->community_Hemiptera_Traps0.05 ##to remove no data colums
dim(community_Hemiptera_Traps0.05)
write.table (community_Hemiptera_Traps0.05, file="../../genetic/Data_out/Hemiptera/Hemiptera5P/community_Hemiptera_Traps0.05.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../../genetic/Data_out/Hemiptera/Hemiptera5P/community_Hemiptera_Traps0.05.txt")->community_Hemiptera_Traps0.05


##**Generating a general table with names and habitat parameters.**
##BY Traps
##**Generating a general table with names and habitat parameters**
row.names(community_Hemiptera_Traps0.05)->sample_names_Mountain1_0.05
...
general_sample_Mountain1Traps0.05
write.table(general_sample_Mountain1Traps0.05, file="../../genetic/Data_out/Hemiptera/Hemiptera5P/general_sample_Mountain1Traps0.05.txt") ##this is the only way I found to be able to work later
read.table("../../genetic/Data_out/Hemiptera/Hemiptera5P/general_sample_Mountain1Traps0.05.txt",header=TRUE)->general_sample_Mountain1Traps0.05



#**HAPLOTYPE RICHNESS TABLES, PLOTS AND ANALYSES by TrapsS**
##**Hemiptera**
as.matrix(community_Hemiptera_Traps0.05)->community_Hemiptera_Traps0.05
row.names(community_Hemiptera_Traps0.05)->sample_names_Traps0.05
dim(community_Hemiptera_Traps0.05)->dims_Traps0.05
dims_Traps0.05
.rowSums (community_Hemiptera_Traps0.05,dims_Traps0.05[1],dims_Traps0.05[2])->sample_richness_Traps0.05 ##summatory by rows
...
##**BY Traps**
write.table(richness_Traps0.05, file="../../genetic/Data_out/Hemiptera/Hemiptera5P/richness_Traps0.05_Hemiptera.txt") ##this is the only way I found to be able to work later
read.table("../../genetic/Data_out/Hemiptera/Hemiptera5P/richness_Traps0.05_Hemiptera.txt",header=TRUE)->richness_Traps0.05

##**BY Traps_C general**
#write.table(richness_TrapsC, file="../../genetic/Data_out/Hemiptera/Hemiptera5P/richness_TrapsC_Hemiptera.txt") ##this is the only way I found to be able to work later
#read.table("../../genetic/Data_out/Hemiptera/Hemiptera5P/richness_TrapsC_Hemiptera.txt",header=TRUE)->richness_TrapsC

##**General plot of richness by sample in Traps**
barplot(richness_Traps0.05$sample_richness_Traps0.05,col=richness_Traps0.05$Mountain1Traps,names.arg= richness_Traps0.05$sample_names_Traps0.05,las=2,cex.names=0.5, ylab="richness_Traps0.05", main="H richness_Traps Hemiptera_0.05")
...
text(x=4.5, y=1, labels="ns", cex=2)
...
beta.multi(community_Hemiptera_Traps0.05, index.family="sorensen")

##turnover by pairs, nmds, anosim
beta.pair(community_Hemiptera_Traps0.05, index.family="sorensen")->beta.pair  ##betadiversity by pair of communities using sorensen on the precense/absence data, with estimation of turnover and nestedness datamatrixes simultaneously
metaMDS (beta.pair$beta.sim)->MDSbetasim_T0.05 ##NMDS

plot (MDSbetasim_T0.05, main="Hemiptera_Traps_0.05") 
x<- MDSbetasim_T0.05$points[,1]
y<- MDSbetasim_T0.05$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Hemiptera_Traps0.05))

##**By SITES quitar**
##**repeating after removing outlayers from matrix and general habitat table**
community_Hemiptera_Traps0.05[-which(row.names(community_Hemiptera_Traps0.05) %in% c("SJH_T_W_3SHCO5C2W")),]->community_Hemiptera_Traps_sinoutlayer
...
general_sample_Mountain1Traps0.05[-which(general_sample_Mountain1Traps0.05$sample_names %in% c("SJH_T_W_3SHCO5C2W")),]->general_sample_Traps_sinoutlayer
...
plot (MDSbetasim_Th1, main="Hemiptera_Traps0.05") 
...
plot (MDSbetasim_Th1, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Hemiptera_Traps0.05")
...
text(x=0.50, y=-0.35, labels="=0.10 ns", cex=2)
...
dim(community_Hemiptera0.05)
community_Hemiptera0.05[which(str_extract (row.names(community_Hemiptera0.05), "G_") %in% "G_"),]->community_Hemiptera_Groups0.05
dim(community_Hemiptera_Groups0.05)
community_Hemiptera_Groups0.05[,which(colSums(community_Hemiptera_Groups0.05)!=0)]->community_Hemiptera_Groups0.05 ##to remove no data colums
dim(community_Hemiptera_Groups0.05)
write.table (community_Hemiptera_Groups0.05, file="../../genetic/Data_out/Hemiptera/Hemiptera5P/community_Hemiptera_Groups0.05.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../../genetic/Data_out/Hemiptera/Hemiptera5P/community_Hemiptera_Groups0.05.txt")->community_Hemiptera_Groups0.05


##**Generating a general table with names and habitat parameters.**
##BY Groups
##**Generating a general table with names and habitat parameters**
row.names(community_Hemiptera_Groups0.05)->sample_names_Mountain2_0.05
...
general_sample_Mountain2Groups0.05
write.table(general_sample_Mountain2Groups0.05, file="../../genetic/Data_out/Hemiptera/Hemiptera5P/general_sample_Mountain2Groups0.05.txt") ##this is the only way I found to be able to work later
read.table("../../genetic/Data_out/Hemiptera/Hemiptera5P/general_sample_Mountain2Groups0.05.txt",header=TRUE)->general_sample_Mountain2Groups0.05



#**HAPLOTYPE RICHNESS TABLES, PLOTS AND ANALYSES by GroupsS**
##**Hemiptera**
as.matrix(community_Hemiptera_Groups0.05)->community_Hemiptera_Groups0.05
row.names(community_Hemiptera_Groups0.05)->sample_names_Groups0.05
dim(community_Hemiptera_Groups0.05)->dims_Groups0.05
dims_Groups0.05
.rowSums (community_Hemiptera_Groups0.05,dims_Groups0.05[1],dims_Groups0.05[2])->sample_richness_Groups0.05 ##summatory by rows
...
##**BY Groups**
write.table(richness_Groups0.05, file="../../genetic/Data_out/Hemiptera/Hemiptera5P/richness_Groups0.05_Hemiptera.txt") ##this is the only way I found to be able to work later
read.table("../../genetic/Data_out/Hemiptera/Hemiptera5P/richness_Groups0.05_Hemiptera.txt",header=TRUE)->richness_Groups0.05

##**BY Groups_C general**
#write.table(richness_GroupsC, file="../../genetic/Data_out/Hemiptera/Hemiptera5P/richness_GroupsC_Hemiptera.txt") ##this is the only way I found to be able to work later
#read.table("../../genetic/Data_out/Hemiptera/Hemiptera5P/richness_GroupsC_Hemiptera.txt",header=TRUE)->richness_GroupsC

##**General plot of richness by sample in Groups**
barplot(richness_Groups0.05$sample_richness_Groups0.05,col=richness_Groups0.05$Mountain2Groups,names.arg= richness_Groups0.05$sample_names_Groups0.05,las=2,cex.names=0.5, ylab="richness_Groups0.05", main="H richness_Groups Hemiptera_0.05")
...
plot(richness_Groups0.05$Mountain2Groups,richness_Groups0.05$sample_richness_Groups0.05,ylab="richness_Groups_0.05_Hemiptera", cex=1.4, cex.axis=2.3, lwd=2.5, ylim=c(0,15))
...
text(x=5.5, y=1, labels="ns", cex=2)
mtext(c("lineages 5%"), side = 3, col = "black", line = 1, cex = 2)
...
beta.multi(community_Hemiptera_Groups0.05, index.family="sorensen")

##turnover by pairs, nmds, anosim
beta.pair(community_Hemiptera_Groups0.05, index.family="sorensen")->beta.pair  ##betadiversity by pair of communities using sorensen on the precense/absence data, with estimation of turnover and nestedness datamatrixes simultaneously
metaMDS (beta.pair$beta.sim)->MDSbetasim_G0.05 ##NMDS

plot (MDSbetasim_G0.05, main="Hemiptera_Groups_0.05") 
x<- MDSbetasim_G0.05$points[,1]
y<- MDSbetasim_G0.05$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Hemiptera_Groups0.05))

plot (MDSbetasim_G0.05, main="Hemiptera_Groups_0.05")
with(general_sample_Mountain2Groups0.05,ordispider(MDSbetasim_G0.05, Mountain2, label=T, col="blue"))

plot (MDSbetasim_G0.05, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Hemiptera_Groups_0.05")
with(general_sample_Mountain2Groups0.05,ordispider(MDSbetasim_G0.05, Mountain2, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0", "#c1d6b1")))
...
with(general_sample_Mountain2Groups0.05,ordispider(MDSbetasim_G0.05, Mountain2, label=T, cex.lab=1, col= c("#153a7b", "#eaa22f", "#97518b", "#81b9d0", "#c1d6b1"), lwd=4.5))
##I put letter "r" in cursive and r2 value
mylabel = bquote(italic(r)^2)
text(x=0.23, y=-0.35, labels = mylabel, cex=1.5)
text(x=0.48, y=-0.35, labels="=0.002 ns", cex=1.5)
mtext(c("lineages 5%"), side = 3, col = "black", line = 1, cex = 2)
