...
s2_raw_threshold [,1:26]->s2_raw_threshold ##remove threshold col
...
t_s2_f4_h[2:26,]->community_Collembola_h #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data".
...
dim(community_Collembola_h)
community_Collembola_h[which(str_extract (row.names(community_Collembola_h), "_T_") %in% "_T_"),]->community_Collembola_Traps_h
dim(community_Collembola_Traps_h)
community_Collembola_Traps_h[,which(colSums(community_Collembola_Traps_h)!=0)]->community_Collembola_Traps_h ##to remove no data colums
dim(community_Collembola_Traps_h)
write.table (community_Collembola_Traps_h, file="../../genetic/Data_out/Collembola/Collembola_Haplotypes/community_Collembola_Traps_h.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../../genetic/Data_out/Collembola/Collembola_Haplotypes/community_Collembola_Traps_h.txt")->community_Collembola_Traps_h


##**BY Traps**
##**Generating a general table with names and habitat parameters**
row.names(community_Collembola_Traps_h)->sample_names_Mountain1_h
...
general_sample_Mountain1Traps_h
write.table(general_sample_Mountain1Traps_h, file="../../genetic/Data_out/Collembola/Collembola_Haplotypes/general_sample_Mountain1Traps_h.txt") ##this is the only way I found to be able to work later
read.table("../../genetic/Data_out/Collembola/Collembola_Haplotypes/general_sample_Mountain1Traps_h.txt",header=TRUE)->general_sample_Mountain1Traps_h



#**HAPLOTYPE RICHNESS TABLES, PLOTS AND ANALYSES by TrapsS** 
##Collembola
as.matrix(community_Collembola_Traps_h)->community_Collembola_Traps_h
row.names(community_Collembola_Traps_h)->sample_names_Traps_h
dim(community_Collembola_Traps_h)->dims_Traps_h
dims_Traps_h
.rowSums (community_Collembola_Traps_h,dims_Traps_h[1],dims_Traps_h[2])->sample_richness_Traps_h ##summatory by rows
rbind(sample_names_Traps_h,sample_richness_Traps_h)->richness_Traps_h_Collembola
t(richness_Traps_h_Collembola)->richness_Traps_h_Collembola
colnames(richness_Traps_h_Collembola)<-c("sample_names_Traps_h","sample_richness_Traps_h")
richness_Traps_h_Collembola
as.data.frame(richness_Traps_h_Collembola)->richness_Traps_h_Collembola

##**Generating variables with Traps. En la tabla rishnees. Generar variable de montana y sitio.** 
richness_Traps_h_Collembola %>% separate(sample_names_Traps_h, c("Conservation1","Mountain1","Traps","ID"), sep="_",remove=FALSE)->richness_Traps_h_Collembola
richness_Traps_h_Collembola
richness_Traps_h_Collembola %>% unite(Mountain1Traps, Mountain1, Traps, sep="_",remove=FALSE)->richness_Traps_h_Collembola ##generating a variable combining layer and habitat
richness_Traps_h_Collembola

##**Generating variables with in total Traps_C.**
#richness_Traps_h_Collembola %>% separate(sample_names_Traps_h, c("Conservation1","Mountain1","Traps","ID"), sep="_",remove=FALSE)->richness_TrapsC
#richness_TrapsC
...
##**BY Traps**
write.table(richness_Traps_h_Collembola, file="../../genetic/Data_out/Collembola/Collembola_Haplotypes/richness_Traps_h_Collembola.txt") ##this is the only way I found to be able to work later
...
##**BY Traps_C general**
#write.table(richness_TrapsC, file="../../genetic/Data_out/Collembola/Collembola_Haplotypes/richness_TrapsC_Collembola.txt") ##this is the only way I found to be able to work later
#read.table("../../genetic/Data_out/Collembola/Collembola_Haplotypes/richness_TrapsC_Collembola.txt",header=TRUE)->richness_TrapsC

##**General plot of richness by sample in Traps**
barplot(richness_Traps_h_Collembola$sample_richness_Traps_h,col=richness_Traps_h_Collembola$Mountain1Traps,names.arg= richness_Traps_h_Collembola$sample_names_Traps_h, las=2,cex.names=0.5, ylab="richness_Traps_h_Collembola", main="H richness_Traps Collembola")
richness_Traps_h_Collembola %>% group_by(Mountain1Traps) %>% summarise(mean(sample_richness_Traps_h))

##**min, max, ds Summarise**
richness_Traps_h_Collembola %>% group_by(Mountain1Traps) %>% summarise(mean(sample_richness_Traps_h))
richness_Traps_h_Collembola %>% group_by(Mountain1Traps) %>% summarise(min(sample_richness_Traps_h))
richness_Traps_h_Collembola %>% group_by(Mountain1Traps) %>% summarise(max(sample_richness_Traps_h))
richness_Traps_h_Collembola %>% group_by(Mountain1Traps) %>% summarise(sd(sample_richness_Traps_h))

##**Global richness by Traps.**  
plot(richness_Traps_h_Collembola$Mountain1Traps,richness_Traps_h_Collembola$sample_richness_Traps_h,ylab="richness_Traps_h_Collembola", cex=1.4, cex.axis=2.3, lwd=2.5, ylim=c(0,30))
kruskal.test(sample_richness_Traps_h ~ Mountain1Traps, data = richness_Traps_h_Collembola)
#posthoc.kruskal.nemenyi.test(x=richness_Traps_h_Collembola$sample_richness_Traps_h, g=richness_Traps_h_Collembola$Mountain1Traps, method="Bonferroni")
#PMCMRplus::kwAllPairsNemenyiTest(x=richness_Traps_h_Collembola$sample_richness_Traps_h, g=richness_Traps_h_Collembola$Mountain1Traps, dist = c("Tukey", "Chisquare"), p.adjust.method="bonferroni")
...
text(x=3.5, y=1, labels="ns", cex=2)

#**BETADIVERSITY ORDINATIONS by Trapss** 
#**Collembola**
##beta general

beta.multi(community_Collembola_Traps_h, index.family="sorensen")

##turnover by pairs, nmds, anosim
beta.pair(community_Collembola_Traps_h, index.family="sorensen")->beta.pair  ##betadiversity by pair of communities using sorensen on the precense/absence data, with estimation of turnover and nestedness datamatrixes simultaneously
metaMDS (beta.pair$beta.sim)->MDSbetasim_Th ##NMDS

plot (MDSbetasim_Th, main="Collembola_Traps_h") 
x<- MDSbetasim_Th$points[,1]
y<- MDSbetasim_Th$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Collembola_Traps_h))

plot (MDSbetasim_Th, main="Collembola_Traps_h")
with(general_sample_Mountain1Traps_h,ordispider(MDSbetasim_Th, Traps, label=T, col="blue"))

plot (MDSbetasim_Th, xlim=c(-0.4, 0.4), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Collembola_Traps_h")
...
text(x=0.48, y=-0.35, labels="=0.18 ns", cex=2)
