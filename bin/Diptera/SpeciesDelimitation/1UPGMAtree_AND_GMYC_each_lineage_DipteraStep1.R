...
#**Diptera**
Diptera583 <- read.FASTA("../../../genetic/Orders9&Etiquetas/Dipteras_583_33SOPAS_UNIQUES_ExpeRelabel420_20_26_1_alignment.fasta")  #leer fasta
dist.dna(Diptera583, model = "F84", as.matrix = T)->dist_Diptera583  #calcular matriz distancias por pares
Diptera583_UPGMA <- upgma(dist_Diptera583)  #hacer árbol
plot(Diptera583_UPGMA)
...
Diptera583_UPGMA.GMYC.singleThreshold<-gmyc.edit(Diptera583_UPGMA, method="s") #hacer GMYC
#resumen de los resultados
summary(Diptera583_UPGMA.GMYC.singleThreshold) #Mostrar resumen GMYC

sink("../../Diptera/SpeciesDelimitation/Diptera_UPGMA.GMYC.singleThreshold.log", type=c("output","message"), split=TRUE) #guardar resultado del GMYC (resumen)
#MIT.test.s o MIT.test.m para ver todos los datos
summary(Diptera583_UPGMA.GMYC.singleThreshold)
sink()
