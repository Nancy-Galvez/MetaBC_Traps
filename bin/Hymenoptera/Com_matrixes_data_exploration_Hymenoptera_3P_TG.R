...
for (i in 1:length(unique (s2_raw_threshold$limite0.03)))
{
  ...
  subcom_level_names0.03[,c(2:28)]->subcom_level0.03  #delete names, level and also the negative column
...
s2_raw_Hymenoptera_limite0.03[,1:27]->data0.03
rowSums(data0.03)
...
t_s2_f4_Hymenoptera_limite0.03[1:27,]->community_Hymenoptera_limite0.03 #NOTA_Nancy: Este numero es importante. Colocar exactamente el numero de "s2_f4[,2:52]->data0.03".
...
dim(community_Hymenoptera0.03)
community_Hymenoptera0.03[which(str_extract (row.names(community_Hymenoptera0.03), "_T_") %in% "_T_"),]->community_Hymenoptera_Traps0.03
dim(community_Hymenoptera_Traps0.03)
community_Hymenoptera_Traps0.03[,which(colSums(community_Hymenoptera_Traps0.03)!=0)]->community_Hymenoptera_Traps0.03 ##to remove no data colums
dim(community_Hymenoptera_Traps0.03)
write.table (community_Hymenoptera_Traps0.03, file="../../genetic/Data_out/Hymenoptera/Hymenoptera3P/community_Hymenoptera_Traps0.03.txt") ##this is necessary for the format, not able to solve in other way
read.table ("../../genetic/Data_out/Hymenoptera/Hymenoptera3P/community_Hymenoptera_Traps0.03.txt")->community_Hymenoptera_Traps0.03


##**Generating a general table with names and habitat parameters.**
##BY Traps
##**Generating a general table with names and habitat parameters**
row.names(community_Hymenoptera_Traps0.03)->sample_names_Mountain1_0.03
...
general_sample_Mountain1Traps0.03
write.table(general_sample_Mountain1Traps0.03, file="../../genetic/Data_out/Hymenoptera/Hymenoptera3P/general_sample_Mountain1Traps0.03.txt") ##this is the only way I found to be able to work later
read.table("../../genetic/Data_out/Hymenoptera/Hymenoptera3P/general_sample_Mountain1Traps0.03.txt",header=TRUE)->general_sample_Mountain1Traps0.03



#**HAPLOTYPE RICHNESS TABLES, PLOTS AND ANALYSES by TrapsS**
##**Hymenoptera**
as.matrix(community_Hymenoptera_Traps0.03)->community_Hymenoptera_Traps0.03
row.names(community_Hymenoptera_Traps0.03)->sample_names_Traps0.03
dim(community_Hymenoptera_Traps0.03)->dims_Traps0.03
dims_Traps0.03
.rowSums (community_Hymenoptera_Traps0.03,dims_Traps0.03[1],dims_Traps0.03[2])->sample_richness_Traps0.03 ##summatory by rows
...
##**BY Traps**
write.table(richness_Traps0.03, file="../../genetic/Data_out/Hymenoptera/Hymenoptera3P/richness_Traps0.03_Hymenoptera.txt") ##this is the only way I found to be able to work later
read.table("../../genetic/Data_out/Hymenoptera/Hymenoptera3P/richness_Traps0.03_Hymenoptera.txt",header=TRUE)->richness_Traps0.03

##**BY Traps_C general**
#write.table(richness_TrapsC, file="../../genetic/Data_out/Hymenoptera/Hymenoptera3P/richness_TrapsC_Hymenoptera.txt") ##this is the only way I found to be able to work later
#read.table("../../genetic/Data_out/Hymenoptera/Hymenoptera3P/richness_TrapsC_Hymenoptera.txt",header=TRUE)->richness_TrapsC

##**General plot of richness by sample in Traps**
barplot(richness_Traps0.03$sample_richness_Traps0.03,col=richness_Traps0.03$Mountain1Traps,names.arg= richness_Traps0.03$sample_names_Traps0.03,las=2,cex.names=0.5, ylab="richness_Traps0.03", main="H richness_Traps Hymenoptera_0.03")
...
text(x=4.3, y=0.4, labels="ns", cex=2)
...
beta.multi(community_Hymenoptera_Traps0.03, index.family="sorensen")

##turnover by pairs, nmds, anosim
beta.pair(community_Hymenoptera_Traps0.03, index.family="sorensen")->beta.pair  ##betadiversity by pair of communities using sorensen on the precense/absence data, with estimation of turnover and nestedness datamatrixes simultaneously
metaMDS (beta.pair$beta.sim)->MDSbetasim_T0.03 ##NMDS

plot (MDSbetasim_T0.03, main="Hymenoptera_Traps_0.03") 
x<- MDSbetasim_T0.03$points[,1]
y<- MDSbetasim_T0.03$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Hymenoptera_Traps0.03))

plot (MDSbetasim_T0.03, main="Hymenoptera_Traps_0.03")
with(general_sample_Mountain1Traps0.03,ordispider(MDSbetasim_T0.03, Traps, label=T, col="blue"))

plot (MDSbetasim_T0.03, xlim=c(-0.4, 0.4), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Hymenoptera_Traps_0.03")
...
text(x=0.42, y=-0.35, labels="=0.0.7 ns", cex=2)
mtext(c("lineages 3%"), side = 3, col = "black", line = 1, cex = 2)
...
dim(community_Hymenoptera0.03)
community_Hymenoptera0.03[which(str_extract (row.names(community_Hymenoptera0.03), "G_") %in% "G_"),]->community_Hymenoptera_Groups0.03
dim(community_Hymenoptera_Groups0.03)
community_Hymenoptera_Groups0.03[,which(colSums(community_Hymenoptera_Groups0.03)!=0)]->community_Hymenoptera_Groups0.03 ##to remove no data colums
dim(community_Hymenoptera_Groups0.03)
write.table (community_Hymenoptera_Groups0.03, file="../../genetic/Data_out/Hymenoptera/Hymenoptera3P/community_Hymenoptera_Groups0.03.txt") ##this is necessary for the format, not able to solve in other way
...
##BY Groups
##**Generating a general table with names and habitat parameters**
row.names(community_Hymenoptera_Groups0.03)->sample_names_Mountain2_0.03
...
general_sample_Mountain2Groups0.03
write.table(general_sample_Mountain2Groups0.03, file="../../genetic/Data_out/Hymenoptera/Hymenoptera3P/general_sample_Mountain2Groups0.03.txt") ##this is the only way I found to be able to work later
...
##**Hymenoptera**
as.matrix(community_Hymenoptera_Groups0.03)->community_Hymenoptera_Groups0.03
row.names(community_Hymenoptera_Groups0.03)->sample_names_Groups0.03
dim(community_Hymenoptera_Groups0.03)->dims_Groups0.03
dims_Groups0.03
.rowSums (community_Hymenoptera_Groups0.03,dims_Groups0.03[1],dims_Groups0.03[2])->sample_richness_Groups0.03 ##summatory by rows
...
##**BY Groups**
write.table(richness_Groups0.03, file="../../genetic/Data_out/Hymenoptera/Hymenoptera3P/richness_Groups0.03_Hymenoptera.txt") ##this is the only way I found to be able to work later
...
##**BY Groups_C general**
#write.table(richness_GroupsC, file="../../genetic/Data_out/Hymenoptera/Hymenoptera3P/richness_GroupsC_Hymenoptera.txt") ##this is the only way I found to be able to work later
#read.table("../../genetic/Data_out/Hymenoptera/Hymenoptera3P/richness_GroupsC_Hymenoptera.txt",header=TRUE)->richness_GroupsC

##**General plot of richness by sample in Groups**
barplot(richness_Groups0.03$sample_richness_Groups0.03,col=richness_Groups0.03$Mountain2Groups,names.arg= richness_Groups0.03$sample_names_Groups0.03,las=2,cex.names=0.5, ylab="richness_Groups0.03", main="H richness_Groups Hymenoptera_0.03")
...
plot(richness_Groups0.03$Mountain2Groups,richness_Groups0.03$sample_richness_Groups0.03,ylab="richness_Groups_0.03_Hymenoptera", cex=1.4, cex.axis=2.3, lwd=2.5, ylim=c(0,15), col= c("#153a7b", "#eaa22f", "#81b9d0"))
...
text(x=3.4, y=1, labels="ns", cex=2)
mtext(c("lineages 3%"), side = 3, col = "black", line = 1, cex = 2)
...
plot (MDSbetasim_G0.03, main="Hymenoptera_Groups_0.03") 
x<- MDSbetasim_G0.03$points[,1]
y<- MDSbetasim_G0.03$points[,2]
text(x, y, pos = 1, cex=0.7, labels = row.names (community_Hymenoptera_Groups0.03))

plot (MDSbetasim_G0.03, main="Hymenoptera_Groups_0.03")
with(general_sample_Mountain2Groups0.03,ordispider(MDSbetasim_G0.03, Mountain2, label=T, col="blue"))

plot (MDSbetasim_G0.03, xlim=c(-0.5, 0.5), ylim=c(-0.4, 0.4), cex.axis=1.4, cex=1.2, cex.lab=1.4, main="Hymenoptera_Groups_0.03")
with(general_sample_Mountain2Groups0.03,ordispider(MDSbetasim_G0.03, Mountain2, label=T, cex.lab=0.9, col= c("#153a7b", "#eaa22f", "#81b9d0")))
...
with(general_sample_Mountain2Groups0.03,ordispider(MDSbetasim_G0.03, Mountain2, label=T, cex.lab=1, col= c("#153a7b", "#eaa22f", "#81b9d0"), lwd=4.5))
##I put letter "r" in cursive and r2 value
mylabel = bquote(italic(r)^2)
text(x=0.25, y=-0.37, labels = mylabel, cex=1.5)
text(x=0.5, y=-0.37, labels="=0.026 ns", cex=1.5)
mtext(c("lineages 3%"), side = 3, col = "black", line = 1, cex = 2)
